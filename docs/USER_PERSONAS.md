...
Directly users are defined by combinations across four main axes:
...
*   **Profile:** A high-volume creator who posts 5x a day across 4 platforms. They love the Directly cloud dashboard but don't want to pay high monthly SaaS fees for storage and AI markups.
...
Instead of forcing users into rigid "Bronze/Silver/Gold" tiers like legacy competitors (which often include things users don't need), Directly should use a **Base + Add-on (Modular)** pricing model, supplemented by a Pay-As-You-Go option. This directly monetizes the combinations above.
...
*   **Toggle 2: Directly Cloud Storage:** +$5/mo per 50GB. (High convenience, high margin for you).

**B. Intelligence (AI Vibe-Writer & Scans)**
*   **Toggle 1: BYOK (Bring Your Own Key):** +$0/mo. (User connects Gemini/OpenAI key).
*   **Toggle 2: Directly Managed AI:** +$10/mo. (Includes 500 AI operations. You buy wholesale API credits and sell retail).
