...
### 1. OpenAI (ChatGPT)
- Go to the [OpenAI Developer Platform](https://platform.openai.com/api-keys).
- Create an account or log in.
- Set up billing/add a payment method (required for API access).
...
### 3. Anthropic (Claude)
- Go to the [Anthropic Console](https://console.anthropic.com/settings/keys).
- Create an account or log in.
- Set up billing/add a payment method to enable API access.
- Click **Create Key**.
- Copy the generated API Key.
