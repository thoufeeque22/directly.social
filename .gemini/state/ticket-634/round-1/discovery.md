...
1. **Script: `scripts/notebook-bundle.ts`**
   ...
   - **Manifest-Driven:** Define a constant `BUNDLE_MANIFEST` containing: `docs/`, `GEMINI.md`, `.gemini/base/*.md`, `prisma/schema.prisma`, and `package.json`.
...
3. **Orchestration Integration: `.gemini/base/ORCHESTRATION.md`**
