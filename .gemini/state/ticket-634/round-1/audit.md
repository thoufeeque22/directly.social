...
- **Orchestration**: `.gemini/base/ORCHESTRATION.md` has been updated to include "NotebookLM Synthesis" as a recommended discovery step for complex tickets, improving overall agent performance.
