...
- **Technical Excellence:** ALL code MUST adhere to the standards in [CORE.md](.gemini/base/CORE.md) (TypeScript Zero-Any, 100-Line Modularity, Centralized Schemas, Swagger Docs).
