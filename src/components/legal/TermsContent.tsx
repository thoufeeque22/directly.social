...
export const TermsContent = () => (
  <Stack spacing={4} sx={{ mt: 4 }}>
    <section>
      <Typography variant="h5" gutterBottom fontWeight={600}>1. Acceptance of Terms</Typography>
    ...
    <section>
      <Typography variant="h5" gutterBottom fontWeight={600}>2. Description of Service</Typography>
      <Typography variant="body1" gutterBottom>
    ...
    <section>
      <Typography variant="h5" gutterBottom fontWeight={600}>3. Third-Party Platforms</Typography>
      <Typography variant="body1" gutterBottom>
    ...
    <section>
      <Typography variant="h5" gutterBottom fontWeight={600}>4. Prohibited Activities</Typography>
      <Typography variant="body1" gutterBottom>
    ...
    <section>
      ...
      <Typography variant="body1" fontWeight={700}>Email: legal@directly.social</Typography>
    </section>
  </Stack>
);
