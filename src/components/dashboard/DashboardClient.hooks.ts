...
export const useDashboardAIState = (initialAITier: AITier, initialAIStyle: StyleMode, initialAIProvider: AIProvider) => {
  ...
  const setAiTier = async (newTier: AITier) => {
    ...
    try { const { updateAIStylePreference } = await import('@/app/actions/user/ai'); await updateAIStylePreference(newTier); } catch (err) { console.error(err); }
  };
  ...
  const setAiProvider = async (newProvider: AIProvider) => {
    ...
    try { const { updateAIProviderPreference } = await import('@/app/actions/user/ai'); await updateAIProviderPreference(newProvider); } catch (err) { console.error(err); }
  };
  ...
  const setContentMode = async (newMode: StyleMode) => {
    ...
    try { const { updateAIStyleModePreference } = await import('@/app/actions/user/ai'); await updateAIStyleModePreference(newMode); } catch (err) { console.error(err); }
  };
