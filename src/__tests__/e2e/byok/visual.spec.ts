...
test.describe('BYOK Wizard Visual Audit', () => {
  ...
  test('capture visual states of BYOK wizard', async ({ page }) => {
    ...
    await page.locator('.ptr-container').screenshot({ path: 'verification/byok-wizard-filled.png' });
    ...
    await page.locator('.ptr-container').screenshot({ path: 'verification/byok-wizard-error.png' });
