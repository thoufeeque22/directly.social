...
description: Audit and optimize the project's AI orchestration and instruction files. Use this skill to identify contradictions, redundancies, and friction points in GEMINI.md, .agents/base/*.md, and agent definitions.
---
...
4.  **Align Agents**: Ensure agent-specific workflows in `.agents/agents/` are consistent with global mandates in `GEMINI.md`.
...
- `.agents/base/CORE.md` (Technical standards)
- `.agents/base/ORCHESTRATION.md` (Workflow mandates)
- `.agents/base/UI_UX.md` (Aesthetic standards)
- `.agents/base/PRODUCTION.md` (Infrastructure standards)
- `.agents/agents/base/*.md` (Agent-specific instructions)

### 2. Analyze Friction Points
Read `.agents/incidental_observations.json`. Look for:
